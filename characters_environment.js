...
function game(){
  console.log("X value of nose -"+NoseX+"Y value of nose-"+NoseY);
  instializeInDraw();
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press Start button to Play and keep your nose ready to move ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
